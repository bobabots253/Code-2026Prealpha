...
public class rollerModule {
  private final rollerModuleIO io;
  private final rollerModuleIOInputsAutoLogged inputs = new ModuleIOInputsAutoLogged();
  ...
  public rollerModule(rollerModuleIO io) {
    this.io = io;
    // this.index = index;
    rollerDisconnectedAlert =
        new Alert(
            "Disconnected roller motor.",
            AlertType.kError);
  ...
  public void periodic() {
    ...
    // Update alerts
    rollerDisconnectedAlert.set(!inputs.driveConnected);
